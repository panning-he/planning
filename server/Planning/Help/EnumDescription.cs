...
namespace Help
{
    ...
    public class EnumDescription : Attribute
    {
        ...
        public static bool ExistsEnumValue(Type enumType, int enumValue)
        {
            ...
            if (fieldTexts == null || fieldTexts.Count == 0)
            {
                return false;
            }
        ...
        public static string GetFieldText(Type enumType, object enumValue)
        {
            ...
            EnumDescription description = fieldTexts.Find(item => item.EnumValue == Convert.ToInt32(enumValue));
            if (description == null)
            {
                return string.Empty;
            }
